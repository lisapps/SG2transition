...
const S_SystemScanResults4 = () => {
  ...
  useEffect(() => {
    let ss4Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-4",
      outputName: "SystemScanResults4",
      headerName: "System Scan Results: 4",
  ...
  if (!contentOptions) return "...Loading System Scan Results 4 Section";
          ...
          <div className="c-systemScanResultsCard__content">
            <div className="l-row">
              <div className="l-row__col l-1/2@md">
                ...
                <p>{contentOptions.s4model && contentOptions.s4model.field}</p>
              </div>
              <div className="l-row__col l-1/2@md">
                <h4 className="u-h6">CPU</h4>
                <p>{contentOptions.s4cpu && contentOptions.s4cpu.field}</p>
                <h4 className="u-h6">OS</h4>
                <p>{contentOptions.s4os && contentOptions.s4os.field}</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  path: "system-scan-results-4",
  component: S_SystemScanResults4,
  navtxt: "System Scan Results: 4",
  htmlName: "SystemScanResults4",
};
