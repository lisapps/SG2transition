...
const S_SystemScanResults5 = () => {
  ...
  useEffect(() => {
    let ss5Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-5",
      outputName: "SystemScanResults5",
      headerName: "System Scan Results: 5",
  ...
  if (!contentOptions) return "...Loading System Scan Results 5 Section";
          ...
          <div className="c-systemScanResultsCard__content">
            <div className="l-row">
              <div className="l-row__col l-1/2@md">
                ...
                <p>{contentOptions.s5model && contentOptions.s5model.field}</p>
              </div>
              <div className="l-row__col l-1/2@md">
                <h4 className="u-h6">CPU</h4>
                <p>{contentOptions.s5cpu && contentOptions.s5cpu.field}</p>
                <h4 className="u-h6">OS</h4>
                <p>{contentOptions.s5os && contentOptions.s5os.field}</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  path: "system-scan-results-5",
  component: S_SystemScanResults5,
  navtxt: "System Scan Results: 5",
  htmlName: "SystemScanResults5",
};
