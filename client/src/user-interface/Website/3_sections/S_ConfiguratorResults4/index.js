...
const S_ConfiguratorFour = () => {
  ...
  useEffect(() => {
    let conf1Vars = {
      ...appState,
      currentPath: "/ui/configurator-four",
      outputName: "ConfiguratorFour",
      headerName: "Configurator Results: 4",
      description:
  ...
  if (!appState) return "...Loading Configurator Results 4 Section";
              ...
              <div className="c-configuratorResultsCard">
                <div className="c-accordion c-accordion--noOutline">
                  <h5
                    ...
                    id="accTab-83ny2i"
                  >
                    <button aria-controls="accPanel-x1ikxe" aria-expanded="true">
                      <svg
                        className="c-configuratorResultsCard__header__icon"
                        aria-hidden="true"
                        viewBox="0 0 24 24"
...
export default {
  path: "configurator-four",
  component: S_ConfiguratorFour,
  navtxt: "Configurator Results: 4",
  htmlName: "ConfiguratorFour",
  icon: "",
};
