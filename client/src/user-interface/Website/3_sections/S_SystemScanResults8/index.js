...
const S_SystemScanResults8 = () => {
  ...
  useEffect(() => {
    let ss8Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-8",
      outputName: "SystemScanResults8",
      headerName: "System Scan Results: 8",
  ...
  if (!contentOptions) return "...Loading System Scan Results 8 Section";
            ...
            <div className="l-row c-systemScanResultsCard__content__model">
              <div className="l-row__col l-1/2@md">
                <a className="c-systemScanResultsCard__content__model__item" href="#model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>{contentOptions.s8model1 && contentOptions.s8model1.field}</p>
                  </div>
                ...
                <a className="c-systemScanResultsCard__content__model__item" href="#model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>{contentOptions.s8model2 && contentOptions.s8model2.field}</p>
                  </div>
                  <svg viewBox="0 0 100 100">
                    <use
                      xlink="http://www.w3.org/1999/xlink"
              ...
              <div className="l-row__col l-1/2@md">
                <a className="c-systemScanResultsCard__content__model__item" href="#model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>{contentOptions.s8model3 && contentOptions.s8model3.field}</p>
                  </div>
                  <svg viewBox="0 0 100 100">
                    <use
                      xlink="http://www.w3.org/1999/xlink"
...
export default {
  path: "system-scan-results-8",
  component: S_SystemScanResults8,
  navtxt: "System Scan Results: 8",
  htmlName: "SystemScanResults8",
};
