...
const S_ConfiguratorThree = () => {
  ...
  useEffect(() => {
    let conf1Vars = {
      ...appState,
      currentPath: "/ui/configurator-three",
      outputName: "ConfiguratorThree",
      headerName: "Configurator Results: 3",
      description:
  ...
  if (!appState) return "...Loading Configurator Results 3 Section";
                  ...
                  <div className="c-accordion c-accordion--noOutline">
                    ...
                    >
                      <div className="c-accordion__panel__content">
                        <ul className="u-list-unstyled">
                          <li>
                            <p>Intel Core i3 7100U (N/A)</p>
                            <p>Intel Core i5 7300U (N/A)</p>
                            <p>Intel Core i7 7600U (N/A)</p>
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <div className="c-configuratorResultsCard__info">
              <div className="l-row">
                ...
                <div className="l-row__col l-1/2@md">
                  <ul>
                    <li>
                      If 4GB is installed on a 32-bit operating system, the recognized memory may be
                      reduced to 3.5GB or less (depending on system configuration and memory
...
export default {
  path: "configurator-three",
  component: S_ConfiguratorThree,
  navtxt: "Configurator Results: 3",
  htmlName: "ConfiguratorThree",
  icon: "",
};
