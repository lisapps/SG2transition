...
const S_SystemScanResults3 = () => {
  ...
  useEffect(() => {
    let ss3Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-3",
      outputName: "SystemScanResults3",
      headerName: "System Scan Results: 3",
  ...
  if (!contentOptions) return "...Loading System Scan Results 3 Section";
        ...
        <div className="c-systemScanResultsCard">
          ...
          <div className="c-systemScanResultsCard__content">
            ...
            <div className="l-row c-systemScanResultsCard__content__model">
              ...
              <div className="l-row__col l-1/2@md">
                <a className="c-systemScanResultsCard__content__model__item" href="#model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>Lenovo - ThinkPad 11e (2nd Gen) AMD</p>
                  </div>
                  <svg viewBox="0 0 100 100">
                    <use
                      xlink="http://www.w3.org/1999/xlink"
            ...
            <div className="c-systemScanResultsCard__content__cta">
              <a className="c-systemScanResultsCard__content__cta__link" href="#">
                See All Models
              </a>
            </div>
          </div>
          ...
          <div className="c-systemScanResultsCard__content">
            <div className="l-row">
              <div className="l-row__col l-1/2@md">
                ...
                <p>{contentOptions.s3model && contentOptions.s3model.field}</p>
              </div>
              <div className="l-row__col l-1/2@md">
                <h4 className="u-h6">CPU</h4>
                <p>{contentOptions.s3cpu && contentOptions.s3cpu.field}</p>
                <h4 className="u-h6">OS</h4>
                <p>{contentOptions.s3os && contentOptions.s3os.field}</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  path: "system-scan-results-3",
  component: S_SystemScanResults3,
  navtxt: "System Scan Results: 3",
  htmlName: "SystemScanResults3",
};
