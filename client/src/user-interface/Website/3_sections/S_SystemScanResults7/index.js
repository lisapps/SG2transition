...
const S_SystemScanResults7 = () => {
  ...
  useEffect(() => {
    let ss7Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-7",
      outputName: "SystemScanResults7",
      headerName: "System Scan Results: 7",
  ...
  if (!contentOptions) return "...Loading System Scan Results 7 Section";
          ...
          <div className="c-systemScanResultsCard__content">
            ...
            <div className="l-row c-systemScanResultsCard__content__model">
              <div className="l-row__col l-1/2@md">
                <a className="c-systemScanResultsCard__content__model__item" href="#s7model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>{contentOptions.s7model1 && contentOptions.s7model1.field}</p>
                  </div>
              ...
              <div className="l-row__col l-1/2@md">
                <a className="c-systemScanResultsCard__content__model__item" href="#model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>{contentOptions.s7model2 && contentOptions.s7model2.field}</p>
                  </div>
                  <svg viewBox="0 0 100 100">
                    <use
                      xlink="http://www.w3.org/1999/xlink"
...
export default {
  path: "system-scan-results-7",
  component: S_SystemScanResults7,
  navtxt: "System Scan Results: 7",
  htmlName: "SystemScanResults7",
};
