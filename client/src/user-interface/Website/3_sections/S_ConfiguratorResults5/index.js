...
const S_ConfiguratorFive = () => {
  ...
  useEffect(() => {
    let conf1Vars = {
      ...appState,
      currentPath: "/ui/configurator-five",
      outputName: "ConfiguratorFive",
      headerName: "Configurator Results: 5",
      description:
  ...
  if (!appState) return "...Loading Configurator Results 5 Section";
                      ...
                      <div className="c-accordion__panel__content">
                        <ul className="u-list-unstyled">
                          <li>
                            ...
                            <p>1 Socket(s) external USB port for USB drives</p>
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <div className="c-configuratorResultsCard__info">
              <div className="l-row">
                <div className="l-row__col l-1/2@md">
                  <ul>
                    <li>
                      This game console&apos;s USB port can use Kingston&apos;s USB flash drives to
                      transfer media.
                    </li>
                  </ul>
                </div>
                <div className="l-row__col l-1/2@md">
                  <ul>
                    <li>
                      This game console&apos;s internal hard drive can be upgraded with
                      Kingston&apos;s faster SSD flash drives.
                    </li>
                  </ul>
                </div>
              </div>
...
export default {
  path: "configurator-five",
  component: S_ConfiguratorFive,
  navtxt: "Configurator Results: 5",
  htmlName: "ConfiguratorFive",
  icon: "",
};
