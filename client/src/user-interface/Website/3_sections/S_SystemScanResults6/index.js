...
const S_SystemScanResults6 = () => {
  ...
  useEffect(() => {
    let ss6Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-6",
      outputName: "SystemScanResults6",
      headerName: "System Scan Results: 6",
  ...
  if (!contentOptions) return "...Loading System Scan Results 6 Section";
              ...
              <div className="l-row__col">
                <a className="c-systemScanResultsCard__content__model__item" href="#model1">
                  <div className="c-systemScanResultsCard__content__model__item__info">
                    <span>Lenovo</span>
                    <p>{contentOptions.s6model && contentOptions.s6model.field}</p>
                  </div>
...
export default {
  path: "system-scan-results-6",
  component: S_SystemScanResults6,
  navtxt: "System Scan Results: 6",
  htmlName: "SystemScanResults6",
};
