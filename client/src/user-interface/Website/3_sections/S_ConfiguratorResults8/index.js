...
const S_ConfiguratorEight = () => {
  ...
  useEffect(() => {
    let conf1Vars = {
      ...appState,
      currentPath: "/ui/configurator-eight",
      outputName: "ConfiguratorEight",
      headerName: "Configurator Results: 8",
      description:
  ...
  if (!appState) return "...Loading Configurator Results 8 Section";
                ...
                <div className="c-configuratorResultsCard">
                  <div className="c-accordion c-accordion--noOutline">
                    <h5
                      ...
                      id="accTab-sqw8bj"
                    >
                      <button aria-controls="accPanel-ornhu3" aria-expanded="true">
                        <svg
...
export default {
  path: "configurator-eight",
  component: S_ConfiguratorEight,
  navtxt: "Configurator Results: 8",
  htmlName: "ConfiguratorEight",
  icon: "",
};
