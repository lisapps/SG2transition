...
const S_SystemScanResults2 = () => {
  ...
  useEffect(() => {
    let ss2Vars = {
      ...appState,
      currentPath: "/ui/system-scan-results-2",
      outputName: "SystemScanResults2",
      headerName: "System Scan Results: 2",
  ...
  if (!contentOptions) return "...Loading System Scan Results 2 Section";
          ...
          <div className="c-systemScanResultsCard__content">
            <div className="l-row">
              <div className="l-row__col l-1/2@md">
                ...
                <p>{contentOptions.s2model && contentOptions.s2model.field}</p>
              </div>
              <div className="l-row__col l-1/2@md">
                <h4 className="u-h6">CPU</h4>
                <p>{contentOptions.s2cpu && contentOptions.s2cpu.field}</p>
                <h4 className="u-h6">OS</h4>
                <p>{contentOptions.s2os && contentOptions.s2os.field}</p>
              </div>
            </div>
          </div>
        </div>
...
export default {
  path: "system-scan-results-2",
  component: S_SystemScanResults2,
  navtxt: "System Scan Results: 2",
  htmlName: "SystemScanResults2",
};
