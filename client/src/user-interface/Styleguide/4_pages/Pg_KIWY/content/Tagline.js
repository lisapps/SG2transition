          ...
          <div className="l-row">
            <div className="l-row__col l-1/1">
              <p>
                ...
                material. Below are the two options for font use. Please use title-case character as shown here.
              </p>
              <p style={{ marginTop: "1em" }}>
                <img src={imgHashtag} alt="Kingston is with you hashtag" style={{maxWidth:"70%"}}/>
              </p>
            </div>
          </div>
        </div>
